...
<html>
    ...
    <body>
        ...
        <div id="show-funcionario" class="content scaffold-show" role="main">
            ...
            <f:display bean="funcionario" />
            <g:form resource="${this.funcionario}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.funcionario}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
